...
public final class TurtleModelLoader implements IModelLoader<TurtleModelLoader.TurtleModel>
{
    ...
    public static final class TurtleModel implements IModelGeometry<TurtleModel>
    {
        ...
        public Collection<Material> getTextures( IModelConfiguration owner, Function<ResourceLocation, IUnbakedModel> modelGetter, Set<Pair<String, String>> missingTextureErrors )
        {
            ...
            materials.addAll( modelGetter.apply( family ).func_225614_a_( modelGetter, missingTextureErrors ) );
            materials.addAll( modelGetter.apply( COLOUR_TURTLE_MODEL ).func_225614_a_( modelGetter, missingTextureErrors ) );
            return materials;
        }
